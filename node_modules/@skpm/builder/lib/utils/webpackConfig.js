...
let getCommands = (() => {
  var _ref = _asyncToGenerator(function* (output, commandIdentifiers, options) {
  ...
  return (() => {
    var _ref2 = _asyncToGenerator(function* (file, commandIdentifiers, commandHandlers) {
      ...
      if (argv.run && isPluginCommand) {
        plugins = plugins.concat((yield getCommands(output, commandIdentifiers, argv)));
      }
      ...
      let webpackConfig = {
        ...
        entry: _path2.default.join(isPluginCommand ? manifestFolder : process.cwd(), file),
        ...
        output: {
          ...
          path: isPluginCommand ? _path2.default.join(output, 'Contents', 'Sketch') : _path2.default.join(output, 'Contents', 'Resources')
        },
        plugins
      };

      if (userDefinedWebpackConfig) {
        const resolvedUserDefinedConfig = yield userDefinedWebpackConfig(webpackConfig, isPluginCommand);
    ...
    function webpackConfigGenerator(_x4, _x5, _x6) {
