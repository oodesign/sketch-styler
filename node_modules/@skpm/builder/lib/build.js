...
let copyManifest = (() => {
  var _ref = _asyncToGenerator(function* (manifestJSON) {
    return new Promise(function (resolve, reject) {
      ...
      copy.identifier = manifestJSON.identifier || skpmConfig.identifier || skpmConfig.name;
  ...
  var _ref5 = _asyncToGenerator(function* (commands, resources, watch) {
    ...
    for (const command of commands.concat(resources)) {
      ...
      if (watch) {
        ...
        compilers.push(compiler.watch(compiler.options.watchOptions, buildCallback(file, watch)));
      } else {
...
const { argv } = _yargs2.default.option('watch', {
  alias: 'w',
...
(0, _replaceArraysByLastItem2.default)(argv, ['watch', 'quiet', 'run', 'app', 'manifest']);
