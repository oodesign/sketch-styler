...
var globalActiveLibraries; // call the plugin from the webview
...
window.loadNextStyle = function (artboard, index, layerID) {
  ...
  document.getElementById("styleName" + layerID).innerHTML = "".concat(globalUnstyledLayers[artboard][index].matchingStyles.matchingStyles[globalUnstyledLayers[artboard][index].styleLoaded].styleName);
