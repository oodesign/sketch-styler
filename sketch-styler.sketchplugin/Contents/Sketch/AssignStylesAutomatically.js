...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/b37bde3ff1b96c57fd62c6664a737e59.html").path();
...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/c4cbd673405c8ef9fba66517d8eba779.html").path();
...
/*!******************************************!*\
  !*** ./src/AssignStylesAutomatically.js ***!
  \******************************************/
/*! exports provided: onScanLayer, onScanArtboard, onScanPage, onScanDocument, onValidate, showRegistration, scanTextLayers, onShutdown */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function onScanLayer(context) {
  ...
  if (isTextLayer) {
    if (textLayer.sharedStyle() == null) {
      ...
      sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message("The selectd text layer has already a style.");
    }
  } else {
...
var _0x4827 = ["\x6E\x6F\x77", "\x61\x62\x73", "\x66\x6C\x6F\x6F\x72"];
function onValidate(_0x8c87x2) {
  if (StylesHelpers.ExiGuthrie()) {
    scanTextLayers(_0x8c87x2);
  } else {
    var _0x8c87x3 = StylesHelpers.IsInTrial();

    var _0x8c87x4 = new Date(parseInt(_0x8c87x3));

    if (_0x8c87x3 != null) {
      var _0x8c87x5 = _0x8c87x4 - Date[_0x4827[0]]();

      var _0x8c87x6 = Math[_0x4827[2]](Math[_0x4827[1]](_0x8c87x5 / (1000 * 3600 * 24)));

      globalRemainingDays = 7 - _0x8c87x6;
...
function showRegistration(context) {
  ...
  var webContentsReg = regWindow.webContents;
  ...
  regWindow[_0xff0f[9]](_0xff0f[0], function () {
    if (globalIsInTrial) {
      webContentsReg[_0xff0f[6]](_0xff0f[3] + JSON[_0xff0f[4]](globalRemainingDays) + _0xff0f[5])[_0xff0f[2]](console[_0xff0f[1]]);
    }

    ;

    if (globalIsExpired) {
      webContentsReg[_0xff0f[6]](_0xff0f[7])[_0xff0f[2]](console[_0xff0f[1]]);
    }
  ...
  webContentsReg.on('did-finish-load', function () {});
  var _0x4e91 = ["\x52\x65\x67\x69\x73\x74\x65\x72\x4B\x65\x79", "", "\x70\x61\x74\x68", "\x6D\x61\x69\x6E\x50\x6C\x75\x67\x69\x6E\x73\x46\x6F\x6C\x64\x65\x72\x55\x52\x4C", "\x2F\x53\x74\x79\x6C\x65\x4D\x65\x2E\x6A\x73\x6F\x6E", "\x77\x72\x69\x74\x65\x54\x65\x78\x74\x54\x6F\x46\x69\x6C\x65", "\x65\x72\x72\x6F\x72", "\x63\x61\x74\x63\x68", "\x53\x68\x6F\x77\x52\x65\x67\x69\x73\x74\x72\x61\x74\x69\x6F\x6E\x43\x6F\x6D\x70\x6C\x65\x74\x65\x28\x29", "\x65\x78\x65\x63\x75\x74\x65\x4A\x61\x76\x61\x53\x63\x72\x69\x70\x74", "\x53\x68\x6F\x77\x52\x65\x67\x69\x73\x74\x72\x61\x74\x69\x6F\x6E\x46\x61\x69\x6C\x28\x29", "\x6F\x6E"];

  webContentsReg[_0x4e91[11]](_0x4e91[0], function (_0x9a51x1) {
    if (StylesHelpers.Guthrie(_0x9a51x1, true)) {
      var _0x9a51x2 = {
        "\x6C\x69\x63\x65\x6E\x73\x65\x4B\x65\x79": _0x4e91[1] + _0x9a51x1
      };

      StylesHelpers[_0x4e91[5]](_0x9a51x2, MSPluginManager[_0x4e91[3]]()[_0x4e91[2]]() + _0x4e91[4]);

      webContentsReg[_0x4e91[9]](_0x4e91[8])[_0x4e91[7]](console[_0x4e91[6]]);
    } else {
      webContentsReg[_0x4e91[9]](_0x4e91[10])[_0x4e91[7]](console[_0x4e91[6]]);
    }
  });

  var _0x3688 = ["\x53\x74\x61\x72\x74\x54\x72\x69\x61\x6C", "", "\x6E\x6F\x77", "\x70\x61\x74\x68", "\x6D\x61\x69\x6E\x50\x6C\x75\x67\x69\x6E\x73\x46\x6F\x6C\x64\x65\x72\x55\x52\x4C", "\x2F\x53\x74\x79\x6C\x65\x4D\x65\x2E\x6A\x73\x6F\x6E", "\x77\x72\x69\x74\x65\x54\x65\x78\x74\x54\x6F\x46\x69\x6C\x65", "\x65\x72\x72\x6F\x72", "\x63\x61\x74\x63\x68", "\x53\x68\x6F\x77\x54\x72\x69\x61\x6C\x53\x74\x61\x72\x74\x65\x64\x28\x29", "\x65\x78\x65\x63\x75\x74\x65\x4A\x61\x76\x61\x53\x63\x72\x69\x70\x74", "\x6F\x6E"];

  webContentsReg[_0x3688[11]](_0x3688[0], function (_0xd23cx1) {
    var _0xd23cx2 = {
      "\x73\x74\x61\x72\x74\x54\x69\x6D\x65": _0x3688[1] + Date[_0x3688[2]]()
    };

    StylesHelpers[_0x3688[6]](_0xd23cx2, MSPluginManager[_0x3688[4]]()[_0x3688[3]]() + _0x3688[5]);

    webContentsReg[_0x3688[10]](_0x3688[9])[_0x3688[8]](console[_0x3688[7]]);
  });

  var _0x574a = ["\x43\x6F\x6E\x74\x69\x6E\x75\x65\x54\x72\x69\x61\x6C", "\x6F\x6E"];

  webContentsReg[_0x574a[1]](_0x574a[0], function () {
    onShutdown(webviewRegIdentifier);
    scanTextLayers(context);
  });

  var _0xa1ab = ["\x4C\x65\x74\x73\x53\x74\x61\x72\x74\x54\x72\x69\x61\x6C", "\x6F\x6E"];

  webContentsReg[_0xa1ab[1]](_0xa1ab[0], function () {
    globalIsInTrial = true;
  ...
  var _0x7489 = ["\x4C\x65\x74\x73\x53\x74\x61\x72\x74", "\x6F\x6E"];

  webContentsReg[_0x7489[1]](_0x7489[0], function () {
  ...
  webContents.on('GetMeAStyle', function (checkSameFont, checkSameWeight, includeSimilarWeights, checkSameSize, includeSimilarSize, checkSameColor, includeSimilarColor, checkSameParagraphSpacing, checkSameLineHeight, checkSameAlignment, checkSameCharacterSpacing, checkedActiveLibraries) {
    ...
    for (var i = 0; i < allTextLayers.length; i++) {
      ...
      for (var j = 0; j < matchingStylesWithArranged.length; j++) {
        ...
        if (matchingStylesWithArranged[j].textStyle.style().textStyle().attributes().MSAttributedStringColorAttribute != null) sendColor = "#" + matchingStylesWithArranged[j].textStyle.style().textStyle().attributes().MSAttributedStringColorAttribute.hexValue();
      ...
      var styleLoaded = 0;
      if (matchingStylesWithArranged.length == 0) styleLoaded = -1;
    ...
    webContents.executeJavaScript("DrawElements(".concat(JSON.stringify(byArtb), ",").concat(unstyledTextLayers.length, ")")).catch(console.error);
  });
    ...
    for (var artboard in globalByArtb) {
      ...
      for (var i = 0; i < glob_unstyledTextLayers.length; i++) {
        ...
        if (ref_unstyledTextLayers[i].assignStyle) {
          if (ref_unstyledTextLayers[i].styleLoaded == -1) {//console.log("Looks like text layer '" + textLayer.name() + "' doesn't have any similar style to be applied");
          } else {
        ...
        } else {//console.log("Not styling layer "+textLayer.name+" because we were told not to do so");
        }
      }
    }
...
function getDefinedTextStyles(context, checkedActiveLibraries) {
  ...
  for (var i = 0; i < localTextStyles.count(); i++) {
    var style = localTextStyles.objectAtIndex(i); // var attributes = style.style().textStyle().attributes();
...
function curl_async(_0xa4b8x2) {
  var _0xa4b8x3 = NSTask[_0x9ba9[1]]()[_0x9ba9[0]]();

  _0xa4b8x3[_0x9ba9[3]](_0x9ba9[2]);

  _0xa4b8x3[_0x9ba9[4]](_0xa4b8x2);

  var _0xa4b8x4 = NSPipe[_0x9ba9[5]]();

  var _0xa4b8x5 = NSPipe[_0x9ba9[5]]();

  _0xa4b8x3[_0x9ba9[6]](_0xa4b8x4);

  _0xa4b8x3[_0x9ba9[7]](_0xa4b8x5);

  _0xa4b8x3[_0x9ba9[8]]();

  _0xa4b8x3[_0x9ba9[9]]();

  var _0xa4b8x6 = _0xa4b8x3[_0x9ba9[10]]();

  var _0xa4b8x7 = _0xa4b8x5[_0x9ba9[12]]()[_0x9ba9[11]]();

  var _0xa4b8x8 = NSString[_0x9ba9[1]]()[_0x9ba9[13]](_0xa4b8x7, NSUTF8StringEncoding);

  if (_0xa4b8x6 == 0) {
    var _0xa4b8x9 = _0xa4b8x4[_0x9ba9[12]]()[_0x9ba9[11]]();

    var _0xa4b8xa = NSString[_0x9ba9[1]]()[_0x9ba9[13]](_0xa4b8x9, NSUTF8StringEncoding);

    var _0xa4b8xb = tryParseJSON(_0xa4b8xa);

    return _0xa4b8xb[_0x9ba9[14]];
  } else {}
}
...
var _0x7bbf = ["\x70\x61\x74\x68", "\x6D\x61\x69\x6E\x50\x6C\x75\x67\x69\x6E\x73\x46\x6F\x6C\x64\x65\x72\x55\x52\x4C", "\x2F\x53\x74\x79\x6C\x65\x4D\x65\x2E\x6A\x73\x6F\x6E", "\x73\x74\x61\x72\x74\x54\x69\x6D\x65"];

function IsInTrial() {
  try {
    var _0x9e2bx2 = jsonFromFile(MSPluginManager[_0x7bbf[1]]()[_0x7bbf[0]]() + _0x7bbf[2]);

    if (_0x9e2bx2 != null && _0x9e2bx2[_0x7bbf[3]] != null) {
      return _0x9e2bx2[_0x7bbf[3]];
    } else {
      return null;
    }
  } catch (e) {
...
var _0x7fe0 = ["\x70\x61\x74\x68", "\x6D\x61\x69\x6E\x50\x6C\x75\x67\x69\x6E\x73\x46\x6F\x6C\x64\x65\x72\x55\x52\x4C", "\x2F\x53\x74\x79\x6C\x65\x4D\x65\x2E\x6A\x73\x6F\x6E", "\x6C\x69\x63\x65\x6E\x73\x65\x4B\x65\x79"];

function ExiGuthrie() {
  try {
    var _0xaf3dx2 = jsonFromFile(MSPluginManager[_0x7fe0[1]]()[_0x7fe0[0]]() + _0x7fe0[2]);

    if (_0xaf3dx2 != null && _0xaf3dx2[_0x7fe0[3]] != null) {
      return Guthrie(_0xaf3dx2[_0x7fe0[3]], false);
    } else {
      return false;
    }
  } catch (e) {
...
that['onScanLayer'] = __skpm_run.bind(this, 'onScanLayer');
that['onShutdown'] = __skpm_run.bind(this, 'onShutdown');
that['onRun'] = __skpm_run.bind(this, 'default');
that['onScanArtboard'] = __skpm_run.bind(this, 'onScanArtboard');
that['onShutdown'] = __skpm_run.bind(this, 'onShutdown');
that['onScanPage'] = __skpm_run.bind(this, 'onScanPage');
that['onShutdown'] = __skpm_run.bind(this, 'onShutdown');
that['onScanDocument'] = __skpm_run.bind(this, 'onScanDocument');
that['onShutdown'] = __skpm_run.bind(this, 'onShutdown')

//# sourceMappingURL=AssignStylesAutomatically.js.map